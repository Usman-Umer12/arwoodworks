...
const productData = {
  "Dining Table": [dt1, dt2, dt3, dt4],
  "Restaurant Furniture": [res1, res2, res3, res4],
  "Sofa Set": [sofa1, sofa2, sofa3, sofa4],
  "Wooden Sofa": [ws1, ws2, ws3, ws4],
  "L.Shape Sofa": [l1, l2, l3, l4],
  "King Size Bed": [bed1, bed2, bed3, bed4],
};
...
export default function FurnitureCategories() {
  ...
  const products = useMemo(() => {
    return (productData[activeCategory] || []).map(
      (image, index) => ({
  ...
  const closePreview = () => setSelectedProduct(null);
          ...
          <div className="mb-6 sm:mb-8">
            ...
            <div className="text-center sm:text-left">
              ...
              <p className="mx-auto mt-2 max-w-xl text-xs leading-5 text-slate-500 sm:mx-0 sm:text-sm sm:leading-6 lg:text-base">
                Explore thoughtfully crafted furniture for every
                corner of your home and workspace.
              </p>
            </div>
          </div>
      ...
      {selectedProduct && (
        ...
        >
          <div className="relative flex max-h-[94dvh] w-full max-w-5xl flex-col overflow-hidden rounded-xl border border-white/10 bg-white shadow-2xl sm:max-h-[90dvh] sm:rounded-2xl">
            ...
            <div className="relative flex min-h-0 flex-1 items-center justify-center overflow-hidden bg-[#F1F4F6] p-2 sm:p-5 lg:p-7">
              <button
                type="button"
                onClick={() => changeProduct(-1)}
                aria-label="Previous image"
                className="absolute left-2 top-1/2 z-10 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full border border-white/40 bg-[#14283D]/90 text-white shadow-lg transition hover:bg-[#079FC0] sm:left-5 sm:h-11 sm:w-11"
              >
                <ChevronLeft size={22} />
              </button>
              ...
              <button
                ...
                className="absolute right-2 top-1/2 z-10 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full border border-white/40 bg-[#14283D]/90 text-white shadow-lg transition hover:bg-[#079FC0] sm:right-5 sm:h-11 sm:w-11"
              >
            ...
            <div className="flex shrink-0 items-center justify-between gap-3 border-t border-slate-200 bg-white px-3 py-3 sm:px-6 sm:py-4">
              ...
              <div className="flex shrink-0 items-center gap-2">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-lg bg-[#14283D] px-3 py-2.5 text-[10px] font-bold text-white transition hover:bg-[#079FC0] sm:px-4 sm:text-xs"
                >
                  <ShoppingBag size={15} />
                  Add to Cart
                </button>
